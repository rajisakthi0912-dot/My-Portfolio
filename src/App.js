    ...
    <>
      ...
      >
        <img
          src="raji-prof.jpg"
          alt="Rajeshwari S"
          className="w-48 h-48 rounded-full shadow-lg object-cover border-4 border-blue-400 float-img"
        />
      ...
      <section id="education" className="py-20 bg-gray-800 text-center">
        ...
        <div className="max-w-4xl mx-auto text-lg text-gray-300">
          <div className="bg-gray-900 p-6 rounded-lg shadow mb-6">
            ...
            <p>
              GPA: <strong>8.7/10 (Upto 6th Sem)</strong>
            </p>
          </div>
          <div className="bg-gray-900 p-6 rounded-lg shadow mb-6">
            <h4 className="font-semibold text-xl text-blue-300">HSC</h4>
            <p>Krishnaveni Govt. Girls Higher Secondary School (2020–2022)</p>
            <p>
              GPA: <strong>8.5</strong>
            </p>
          </div>
          <div className="bg-gray-900 p-6 rounded-lg shadow">
            <h4 className="font-semibold text-xl text-blue-300">SSLC</h4>
            <p>Krishnaveni Govt. Girls Higher Secondary School (2019–2020)</p>
            <p>
              GPA: <strong>8.5</strong>
            </p>
          </div>
      ...
      <section id="experience" className="py-20 text-center">
        ...
        <ul className="text-lg text-gray-300 space-y-4">
          <li>
            💼 <strong>AI & ML Intern</strong> — AICTE + Edunet Foundation
            (Jun–Jul 2025)
          </li>
          <li>
            💼 <strong>Data Science Intern</strong> — Global Knowledge,
            Bengaluru (Aug 2024)
          </li>
          <li>
            💼 <strong>Data Science Intern</strong> — Skill Craft (Nov–Dec 2024)
          </li>
        </ul>
      </section>
      ...
      <section id="contact" className="py-20 bg-gray-800 text-center">
        ...
        <p>
          📧{" "}
          <a
            href="mailto:rajeshwarisakthivel09@gmail.com"
        ...
        <div className="space-x-4 mt-4">
          <a
            href="https://www.linkedin.com/in/rajisakthi"
            target="_blank"
          ...
          <a
            href="https://github.com/rajeshwarisakthi"
            target="_blank"
            className="text-blue-400 hover:underline"
            rel="noreferrer"
          >
          ...
          <a
            href="https://www.hackerrank.com/profile/rajeshwarisakth1"
            target="_blank"
            className="text-blue-400 hover:underline"
            rel="noreferrer"
          >
